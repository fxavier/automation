...
class ExcelToCSVConverter(QMainWindow):
    ...
    def initUI(self):
        ...
        # Add a button to open the period selector
    ...
    def convert_excel_to_csv(self):
        ...
        if not self.period_code:
            QMessageBox.warning(self, 'Warning', 'Please select a period code first.')
            return
        ...
        try:
            ...
            for idx, sheet_name in enumerate(sheet_names):
                ...
                with open(csv_filename, 'w', newline='', encoding='utf-8') as csv_file:
                   ...
                   # Extract headers and ensure 'Datim_code' and 'Period' are in the first line
                    headers = list(rows[0])
